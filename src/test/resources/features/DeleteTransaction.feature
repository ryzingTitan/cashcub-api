Feature: Delete transaction
  ...
  Scenario: Delete an existing transaction
    ...
    And the application will log the following messages:
      | level | message                                                                                                                                                                       |
      | INFO  | Deleting transaction with id 1de572a9-8deb-49c7-88b7-4f353722b224 from budget item id ef91a488-e596-44cc-ac02-5fd2b166f8c6 and budget id 8fca0def-5086-4cae-af5e-11a217288806 |
  ...
  Scenario: Do not delete a budget item that does not exist
    ...
    And the application will log the following messages:
      | level | message                                                                                                                                                                       |
      | INFO  | Deleting transaction with id 2b50aac9-f8b8-4363-a307-e44c7d6453f4 from budget item id ef91a488-e596-44cc-ac02-5fd2b166f8c6 and budget id 8fca0def-5086-4cae-af5e-11a217288806 |

  Scenario: Transactions cannot be deleted with an invalid authorization token
    Given the user has an invalid authorization token
    When a transaction with id 'ef91a488-e596-44cc-ac02-5fd2b166f8c6' is deleted for budget item 'ef91a488-e596-44cc-ac02-5fd2b166f8c6' and budget '8fca0def-5086-4cae-af5e-11a217288806'
